...
Dashboard interactivo de análisis de estadísticas de novatos de la MLB (2020-2025), construido con Python, pandas y Streamlit. Los datos fueron extraídos de [Baseball-Reference](https://www.baseball-reference.com/). (Hasta el 2 de Julio de 2026)
...
Estos datos son recolectados de los jugadores colocados como novatos en sus respectivos años mediante la **regla de elegibilidad de novato de la MLB** (no por su año de debut), la cual estipula lo siguiente:
...
Por ejemplo, Josh Sborz debutó en MLB en 2019, sin embargo su año de novato fue designado por MLB en 2021.
